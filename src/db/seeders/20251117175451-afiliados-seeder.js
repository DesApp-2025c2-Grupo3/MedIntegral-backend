...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const afiliadosARegistrar = [
      ...
      // 2-Titular activa, con grupo familiar complejo
      {
        ...
        grupoFamiliar: [
          ...
          // Miembro 2: Hijo
          {
            ...
            vigenciaFin: null,
            parentescoId: 2,
            emails: [{ direccion: "daenerys.gonz@gmail.com" }], // Agregado
            telefonos: [{ numero: "1122334466" }], // Agregado
            direcciones: [
              {
                calle: "Avenida Corrientes", // Agregado
                altura: 1234,
                pisoDepto: "10A",
                codigoPostal: "C1043",
                localidad: "San Nicolás",
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 2,
            emails: [{ direccion: "lucas.gomez@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "3416667799" }], // Agregado
            direcciones: [
              {
                calle: "Oroño", // Agregado
                altura: 800,
                pisoDepto: "1",
                codigoPostal: "S2000",
                localidad: "Rosario",
      ...
      // 7-Titular activo, sin familia (multiples datos de contacto)
      {
        ...
        telefonos: [{ numero: "2614445566" }, { numero: "2615556677" }],
        direcciones: [
          {
            calle: "Las Heras",
            altura: 450,
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 3,
            emails: [{ direccion: "miguel.sosa@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "3814449999" }], // Agregado
            direcciones: [
              {
                calle: "25 de Mayo", // Agregado
                altura: 300,
                pisoDepto: null,
                codigoPostal: "T4000",
                localidad: "San Miguel de Tucumán",
          ...
          },
          {
            ...
            vigenciaFin: null,
            parentescoId: 4,
            emails: [{ direccion: "elsa.diaz@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "3814448888" }], // Agregado
            direcciones: [
              {
                calle: "25 de Mayo", // Agregado
                altura: 300,
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 3,
            emails: [{ direccion: "leandro.alvarez@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "3434445577" }], // Agregado
            direcciones: [
              {
                calle: "Urquiza", // Agregado
                altura: 100,
                pisoDepto: null,
                codigoPostal: "E3100",
                localidad: "Paraná",
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 2,
            emails: [{ direccion: "sofia.moreno@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "2804443333" }], // Agregado
            direcciones: [
              {
                calle: "Roca", // Agregado
                altura: 700,
          ...
          },
          {
            ...
            vigenciaFin: null,
            parentescoId: 2,
            emails: [{ direccion: "tomas.moreno@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "2804443344" }], // Agregado
            direcciones: [
              {
                calle: "Roca", // Agregado
                altura: 700,
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 2,
            emails: [{ direccion: "benja.gomez@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "2984441133" }], // Agregado
            direcciones: [
              {
                calle: "Tucumán", // Agregado
                altura: 1000,
                pisoDepto: null,
                codigoPostal: "R8332",
                localidad: "General Roca",
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: "2024-06-30",
            parentescoId: 2,
            emails: [{ direccion: "franco.perez@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1158585859" }], // Agregado
            direcciones: [
              {
                calle: "Avenida Vergara", // Agregado
                altura: 2100,
                pisoDepto: null,
                codigoPostal: "B1686",
                localidad: "Hurlingham",
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: "2024-05-30",
            parentescoId: 3,
            emails: [{ direccion: "esteban.alonso@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1134343435" }], // Agregado
            direcciones: [
              {
                calle: "Brandsen", // Agregado
                altura: 2040,
                pisoDepto: null,
                codigoPostal: "B1714",
                localidad: "Ituzaingó",
      ...
      // 19-Titular ACTIVO, simple, varios contactos (Hurlingham)
      {
        ...
        telefonos: [{ numero: "1155554433" }, { numero: "1155554434" }],
        direcciones: [
          {
            calle: "Jauretche",
            altura: 100,
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 2,
            emails: [{ direccion: "mora.sosa@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1163636364" }], // Agregado
            direcciones: [
              {
                calle: "Avenida Rivadavia", // Agregado
                altura: 18100,
                pisoDepto: "8C",
                codigoPostal: "B1708",
                localidad: "Morón",
          ...
          },
          {
            ...
            vigenciaFin: null,
            parentescoId: 2,
            emails: [{ direccion: "dante.sosa@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1163636365" }], // Agregado
            direcciones: [
              {
                calle: "Avenida Rivadavia", // Agregado
                altura: 18100,
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 3,
            emails: [{ direccion: "carla.mendez@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1121212122" }], // Agregado
            direcciones: [
              {
                calle: "Defilippi", // Agregado
                altura: 1300,
                pisoDepto: null,
                codigoPostal: "B1714",
                localidad: "Ituzaingó",
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 4,
            emails: [{ direccion: "amanda.leyes@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1132323233" }], // Agregado
            direcciones: [
              {
                calle: "Santa Rosa", // Agregado
                altura: 500,
                pisoDepto: null,
                codigoPostal: "B1708",
                localidad: "Morón",
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 2,
            emails: [{ direccion: "joaco.campos@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1165656566" }], // Agregado
            direcciones: [
              {
                calle: "Almagro", // Agregado
                altura: 1100,
                pisoDepto: null,
                codigoPostal: "B1714",
                localidad: "Ituzaingó",
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: "2023-11-30",
            parentescoId: 2,
            emails: [{ direccion: "agus.perez@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1161616162" }], // Agregado
            direcciones: [
              {
                calle: "Avenida Cabildo", // Agregado
                altura: 1500,
                pisoDepto: "3F",
                codigoPostal: "C1428",
                localidad: "Belgrano",
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 3,
            emails: [{ direccion: "marcos.pintos@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1138383839" }], // Agregado
            direcciones: [
              {
                calle: "Avenida Cerviño", // Agregado
                altura: 3100,
                pisoDepto: null,
                codigoPostal: "C1425",
                localidad: "Palermo",
      ...
      // 29-Titular ACTIVO, simple, varios contactos (Belgrano)
      {
        ...
        telefonos: [{ numero: "1141414141" }, { numero: "1142424242" }],
        direcciones: [
          {
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 2,
            emails: [{ direccion: "bauti.lopez@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1153535354" }], // Agregado
            direcciones: [
              {
                calle: "Rosario", // Agregado
                altura: 800,
                pisoDepto: null,
                codigoPostal: "C1424",
                localidad: "Caballito",
          ...
          },
          {
            ...
            vigenciaFin: null,
            parentescoId: 2,
            emails: [{ direccion: "cata.lopez@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1153535355" }], // Agregado
            direcciones: [
              {
                calle: "Rosario", // Agregado
                altura: 800,
      ...
      // 31-Titular ACTIVO, con sit. terap. (Palermo)
      {
        ...
        direcciones: [
          {
            calle: "Avenida Scalabrini Ortiz",
            altura: 2000,
            pisoDepto: null,
            codigoPostal: "C1425",
            localidad: "Palermo",
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 2,
            emails: [{ direccion: "valen.guzman@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1173737374" }], // Agregado
            direcciones: [
              {
                calle: "Avenida Congreso", // Agregado
                altura: 2100,
                pisoDepto: "4A",
                codigoPostal: "C1428",
                localidad: "Belgrano",
        ...
        grupoFamiliar: [
          {
            ...
            vigenciaFin: null,
            parentescoId: 3,
            emails: [{ direccion: "vale.luna@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1167676768" }], // Agregado
            direcciones: [
              {
                calle: "Avenida La Plata", // Agregado
                altura: 500,
                pisoDepto: "1C",
                codigoPostal: "C1424",
                localidad: "Caballito",
          ...
          },
          {
            ...
            vigenciaFin: null,
            parentescoId: 4,
            emails: [{ direccion: "angel.romero@ejemplo.com" }], // Agregado
            telefonos: [{ numero: "1167676769" }], // Agregado
            direcciones: [
              {
                calle: "Avenida La Plata", // Agregado
                altura: 500,
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.bulkDelete("AfiliadoSituaciones", null, {
      truncate: true,
      cascade: true,
